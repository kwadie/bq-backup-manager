...
public class BigQueryScope {
    ...
    public BigQueryScope(List<Long> folderIncludeList, List<String> projectIncludeList, List<String> projectExcludeList, List<String> datasetIncludeList, List<String> datasetExcludeList, List<String> tableIncludeList, List<String> tableExcludeList) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getFolderIncludeList(), getProjectIncludeList(), getProjectExcludeList(), getDatasetIncludeList(), getDatasetExcludeList(), getTableIncludeList(), getTableExcludeList());
    }
}
