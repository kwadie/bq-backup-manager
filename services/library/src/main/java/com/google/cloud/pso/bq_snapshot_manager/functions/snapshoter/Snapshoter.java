...
public class Snapshoter {
    ...
    public void execute(Operation request, String trackingId, String pubSubMessageId) throws IOException, NonRetryableApplicationException, InterruptedException {
        ...
        TaggerOperation taggerOperation = new TaggerOperation(
